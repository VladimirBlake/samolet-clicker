...
export default function NotificationPopup({
  ...
  return (
    <div
      data-element="notification-popup"
      className="w-[calc(100%-40px)] absolute bg-[#3496FD] left-1/2 -translate-x-1/2 p-4 rounded-3xl top-1/2 -translate-y-1/2"
    >
